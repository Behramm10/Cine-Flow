-- Function to generate showtimes for the next 14 days
        ...
        FOR day_offset IN 0..13 LOOP
          ...
          LOOP
            ...
            SELECT 
              ...
              (RANDOM() * 200 + 200)::NUMERIC(10,2)  -- Random price between 200-400
            WHERE NOT EXISTS (
...
-- Run the function immediately to generate initial showtimes
SELECT generate_future_showtimes();

-- Create a cron job to run this daily at midnight (requires pg_cron extension)
